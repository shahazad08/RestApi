...
urlpatterns = [
    ...
    path('createnotes/', views.createnotes.as_view(), name='createnotes'),  # For Create
    path('deletenote/', views.deletenote.as_view(), name='deletenote'),  # Delete with PK
    path('delete_from_trash/', views.delete_from_trash.as_view(), name='delete_from_trash'),  # Delete with PK
    ...
    path('colornote/', views.colornote.as_view(), name='colornote'),  # Update with Pk
    path('ispinned/', views.ispinned.as_view(), name='ispinned'),  # Update with Pk
    path('showpinned/', views.showpinned, name='showpinned'),  # Update with Pk
    path('copynote/', views.copynote.as_view(), name='copynote'),  # Update with Pk
    ...
    path('getnote/', views.getnote.as_view(), name='getnote'),
    ...
    path('createcollaborator/', views.createcollaborator.as_view(), name='createcollaborator'),
    path('deletecollaborator/', views.deletecollaborator.as_view(), name='deletecollaborator'),
    path('remainder12/', views.remainder12.as_view(), name='remainder12'),
    #get_all_notes
